...
/**
 * {@link AppLogMapToJsonSerializer}のテストクラス
 *
 * @author Shuji Kitamura
 */
public class AppLogMapToJsonSerializerTest {
    ...
    public void setup() {
        ...
        serializer = new AppLogMapToJsonSerializer(manager);
    ...
    public void ignoreNullValueMemberの設定でnullを出力できること() throws Exception {
        ...
        JsonSerializer serializer = new AppLogMapToJsonSerializer(manager);
        Map<String,String> map = new HashMap<String, String>();
